...
if __name__ == "__main__":
    if (
    ...
    ):  # makes training slightly faster as it eliminates thread context switches
        dataset = sys.argv[2]
        ...
        # Both must be exempt not "either or"
        ...
        model = model_construction(dataset_path.name, epochs, seed, save=True).to(
            device
        )
